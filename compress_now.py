"""
Image Compression Script - Works in current directory
"""
...
def main():
    ...
    for i, image_path in enumerate(images_to_process, 1):
        ...
        if result["success"]:
            ...
            print(f"   ✅ {original_kb:.0f}KB → {new_kb:.0f}KB (-{result['savings']:.1f}%){resize_note}\n")
        else:
            errors += 1
    ...
    print(f"\nBefore: {total_original / 1024 / 1024:.2f} MB")
