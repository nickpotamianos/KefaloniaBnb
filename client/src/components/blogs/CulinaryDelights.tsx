          ...
          <a href="/blog/wine-tasting" className="block group">
            <div className="bg-white rounded-xl overflow-hidden shadow-md transition-all duration-300 group-hover:shadow-xl">
              ...
              <div className="p-5">
                ...
                <p className="text-gray-700 text-sm">Explore Kefalonia's unique wine varieties and visit the island's historic wineries</p>
              </div>
            </div>
          </a>
          ...
          <a href="/blog/beach-exploration" className="block group">
            <div className="bg-white rounded-xl overflow-hidden shadow-md transition-all duration-300 group-hover:shadow-xl">
              ...
              <div className="p-5">
                ...
                <p className="text-gray-700 text-sm">Discover beach tavernas serving the freshest seafood with your toes in the sand</p>
              </div>
            </div>
          </a>
          
          <a href="/blog/nature-hikes" className="block group">
            <div className="bg-white rounded-xl overflow-hidden shadow-md transition-all duration-300 group-hover:shadow-xl">
              <div className="h-48 overflow-hidden">
                <img 
                  src="/images/hike.jpg" 
              ...
              <div className="p-5">
                ...
                <p className="text-gray-700 text-sm">Work up an appetite with scenic hikes through Kefalonia's diverse landscapes</p>
              </div>
            </div>
          </a>
        </div>
