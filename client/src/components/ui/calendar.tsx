  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "!bg-[var(--terracotta)] !text-white hover:!bg-[var(--terracotta)] hover:!text-white focus:!bg-[var(--terracotta)] focus:!text-white",
        day_today: "border-2 border-[var(--sea-blue)] bg-transparent",
        day_outside:
        ...
        day_range_middle:
          "!bg-transparent !text-foreground border border-[var(--terracotta)]",
