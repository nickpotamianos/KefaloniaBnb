          ...
          <div className="md:w-1/2">
            ...
            <div className="mt-10">
              ...
              <div className="flex space-x-4">
                <a href="#" className="text-[#3B83BD] hover:text-[#2C5F89] transition duration-300 flex items-center justify-center w-6 h-6">
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="bg-white rounded-lg p-8 shadow-sm border border-gray-100">
                ...
                <FormField
                  ...
                  name="privacy"
                  render={({ field }) => (
                    <FormItem className="mb-6 flex items-start">
