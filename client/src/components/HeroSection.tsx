...
const HeroSection = () => {
  return (
    <>
      <Helmet>
        <title>Villa Fiscardo | Authentic Greek Island Getaway in Fiscardo</title>
      ...
      >
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-4 z-10">
          ...
          >
            ...
            <h1
              className="text-5xl md:text-7xl text-white font-bold mb-6 playfair leading-tight animate-fade-in opacity-0"
            >
              Villa Fiscardo: <br className="hidden sm:block" /> Your Seaside Escape in Kefalonia
            </h1>

            <p
              className="text-xl md:text-2xl text-white/90 mb-8 max-w-2xl mx-auto font-light animate-fade-in-up delay-100 opacity-0"
            >
