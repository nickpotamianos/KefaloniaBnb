...
const HeroSection = () => {
  return (
    <section 
      ...
      style={{ backgroundImage: "url('https://images.unsplash.com/photo-1519046004466-a95931e4a685?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80')" }}
    >
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-4">
        ...
        >
          Experience the authentic beauty of Greece in our luxury villa with breathtaking views of the Ionian Sea.
        </motion.p>
      ...
      <div className="absolute bottom-10 left-0 right-0 flex justify-center">
        <a 
          ...
          aria-label="Scroll down to house section"
        >
