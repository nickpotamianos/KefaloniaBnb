  ...
  try {
    ...
    const html = `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 650px; margin: 0 auto; padding: 20px; color: #333; line-height: 1.5;">
        ...
        <div style="background: url('images/fiskardo.jpg') center center / cover no-repeat; padding: 40px; border-radius: 12px; margin: 30px 0; position: relative; overflow: hidden;">
